export const en = {
  ...
  products: {
    title: 'Products',
    pageDescription: 'Manage product photos and 3D model files',
    stats: {
      total: 'Total',
    ...
    downloading: 'Open file',
    uploading: (kind: string, pct: number) => `Uploading ${kind}… ${pct}%`,
    saved: 'Saved',
  ...
  materials: {
    title: 'Materials',
    pageDescription: 'Manage your filament stock',
    stats: {
      total: 'Total',
      active: 'Active',
      lowStock: 'Low Stock',
      totalWeight: 'Total Stock',
      weightUnit: 'kg',
    },
    create: {
    ...
    feedback: {
      createSuccess: 'Material added.',
      updateSuccess: 'Material updated.',
      toggleSuccess: 'Status updated.',
      error: 'Something went wrong. Please try again.',
    },
    lowStockBadge: 'Low',
    emptyState: 'No materials yet. Add your first filament above.',
